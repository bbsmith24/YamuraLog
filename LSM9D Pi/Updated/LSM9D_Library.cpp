...
uint16_t LSM9DS1::begin()
{
    ...
    uint8_t mTest = i2cDevice.I2CReadByte(_mAddress, WHO_AM_I_M);
    uint8_t xgTest = i2cDevice.I2CReadByte(_xgAddress, WHO_AM_I_XG);
...
void LSM9DS1::initGyro()
{
    ...
    i2cDevice.I2CWriteByte(_xgAddress, CTRL_REG1_G, tempRegValue);

    // CTRL_REG2_G (Default value: 0x00)
    // [0][0][0][0][INT_SEL1][INT_SEL0][OUT_SEL1][OUT_SEL0]
    // INT_SEL[1:0] - INT selection configuration
    // OUT_SEL[1:0] - Out selection configuration
    i2cDevice.I2CWriteByte(_xgAddress, CTRL_REG2_G, 0x00);
    ...
    i2cDevice.I2CWriteByte(_xgAddress, CTRL_REG3_G, tempRegValue);
    ...
    i2cDevice.I2CWriteByte(_xgAddress, CTRL_REG4, tempRegValue);
    ...
    i2cDevice.I2CWriteByte(_xgAddress, ORIENT_CFG_G, tempRegValue);
}
...
void LSM9DS1::initAccel()
{
    ...
    i2cDevice.I2CWriteByte(_xgAddress, CTRL_REG5_XL, tempRegValue);
    ...
    i2cDevice.I2CWriteByte(_xgAddress, CTRL_REG6_XL, tempRegValue);
    ...
    i2cDevice.I2CWriteByte(_xgAddress, CTRL_REG7_XL, tempRegValue);
}
...
void LSM9DS1::calibrate(bool autoCalc)
{
    ...
    while (samples < 0x1F)
    {
        samples = (i2cDevice.I2CReadByte(_xgAddress, FIFO_SRC) & 0x3F); // Read number of stored samples
    }
...
void LSM9DS1::magOffset(uint8_t axis, int16_t offset)
{
    ...
    msb = (offset & 0xFF00) >> 8;
    lsb = offset & 0x00FF;
    i2cDevice.I2CWriteByte(_mAddress, OFFSET_X_REG_L_M + (2 * axis), lsb);
    i2cDevice.I2CWriteByte(_mAddress, OFFSET_X_REG_H_M + (2 * axis), msb);
}
...
void LSM9DS1::initMag()
{
    ...
    i2cDevice.I2CWriteByte(_mAddress, CTRL_REG1_M, tempRegValue);
    ...
    i2cDevice.I2CWriteByte(_mAddress, CTRL_REG2_M, tempRegValue); // +/-4Gauss
    ...
    i2cDevice.I2CWriteByte(_mAddress, CTRL_REG3_M, tempRegValue); // Continuous conversion mode
    ...
    i2cDevice.I2CWriteByte(_mAddress, CTRL_REG4_M, tempRegValue);
    ...
    tempRegValue = 0;
    i2cDevice.I2CWriteByte(_mAddress, CTRL_REG5_M, tempRegValue);
}

uint8_t LSM9DS1::accelAvailable()
{
    uint8_t status = i2cDevice.I2CReadByte(_xgAddress, STATUS_REG_1);
...
{
    uint8_t status = i2cDevice.I2CReadByte(_mAddress, STATUS_REG_M);
...
int16_t LSM9DS1::readAccel(lsm9ds1_axis axis)
{
    uint8_t temp[2] = {0, 0};
    int16_t value;
    i2cDevice.I2CReadBytes(_xgAddress, OUT_X_L_XL + (2 * axis), temp, 2);
...
{
    uint8_t temp[2] = {0,0};
    i2cDevice.I2CReadBytes(_mAddress, OUT_X_L_M + (2 * axis), temp, 2);
...
void LSM9DS1::readTemp()
{
    ...
    i2cDevice.I2CReadBytes(_xgAddress, OUT_TEMP_L, temp, 2);
...
int16_t LSM9DS1::readGyro(lsm9ds1_axis axis)
{
    ...
    i2cDevice.I2CReadBytes(_xgAddress, OUT_X_L_G + (2 * axis), temp, 2);
...
void LSM9DS1::setGyroScale(uint16_t gScl)
{
    ...
    uint8_t ctrl1RegValue = i2cDevice.I2CReadByte(_xgAddress, CTRL_REG1_G);
    ...
    i2cDevice.I2CWriteByte(_xgAddress, CTRL_REG1_G, ctrl1RegValue);
...
void LSM9DS1::setAccelScale(uint8_t aScl)
{
    ...
    uint8_t tempRegValue = i2cDevice.I2CReadByte(_xgAddress, CTRL_REG6_XL);
...
void LSM9DS1::setMagScale(uint8_t mScl)
{
    ...
    uint8_t temp = i2cDevice.I2CReadByte(_mAddress, CTRL_REG2_M);
    ...
    i2cDevice.I2CWriteByte(_mAddress, CTRL_REG2_M, temp);
...
void LSM9DS1::setGyroODR(uint8_t gRate)
{
    ...
    if ((gRate & 0x07) != 0)
    {
        ...
        uint8_t temp = i2cDevice.I2CReadByte(_xgAddress, CTRL_REG1_G);
        ...
        i2cDevice.I2CWriteByte(_xgAddress, CTRL_REG1_G, temp);
    }
}
...
void LSM9DS1::setAccelODR(uint8_t aRate)
{
    ...
    if ((aRate & 0x07) != 0)
    {
        ...
        uint8_t temp = i2cDevice.I2CReadByte(_xgAddress, CTRL_REG6_XL);
        ...
        i2cDevice.I2CWriteByte(_xgAddress, CTRL_REG6_XL, temp);
    }
}
...
void LSM9DS1::setMagODR(uint8_t mRate)
{
    ...
    uint8_t temp = i2cDevice.I2CReadByte(_mAddress, CTRL_REG1_M);
    ...
    i2cDevice.I2CWriteByte(_mAddress, CTRL_REG1_M, temp);
}
                         ...
                         h_lactive activeLow, pp_od pushPull)
{
    ...
    i2cDevice.I2CWriteByte(_xgAddress, interrupt, generator);

    // Configure CTRL_REG8
    uint8_t temp = i2cDevice.I2CReadByte(_xgAddress, CTRL_REG8);
    ...
    i2cDevice.I2CWriteByte(_xgAddress, CTRL_REG8, temp);
}
...
void LSM9DS1::configInactivity(uint8_t duration, uint8_t threshold, bool sleepOn)
{
    ...
    temp = threshold & 0x7F;
    if (sleepOn) temp |= (1<<7);
    i2cDevice.I2CWriteByte(_xgAddress, ACT_THS, temp);

    i2cDevice.I2CWriteByte(_xgAddress, ACT_DUR, duration);
}

uint8_t LSM9DS1::getInactivity()
{
    uint8_t temp = i2cDevice.I2CReadByte(_xgAddress, STATUS_REG_0);
    temp &= (0x10);
    return temp;
}
...
void LSM9DS1::configAccelInt(uint8_t generator, bool andInterrupts)
{
    ...
    i2cDevice.I2CWriteByte(_xgAddress, INT_GEN_CFG_XL, temp);
}
...
void LSM9DS1::configAccelThs(uint8_t threshold, lsm9ds1_axis axis, uint8_t duration, bool wait)
{
    ...
    i2cDevice.I2CWriteByte(_xgAddress, INT_GEN_THS_X_XL + axis, threshold);

    // Write duration and wait to INT_GEN_DUR_XL
    uint8_t temp;
    temp = (duration & 0x7F);
    if (wait) temp |= 0x80;
    i2cDevice.I2CWriteByte(_xgAddress, INT_GEN_DUR_XL, temp);
}

uint8_t LSM9DS1::getAccelIntSrc()
{
    uint8_t intSrc = i2cDevice.I2CReadByte(_xgAddress, INT_GEN_SRC_XL);
...
void LSM9DS1::configGyroInt(uint8_t generator, bool aoi, bool latch)
{
    ...
    if (aoi) temp |= 0x80;
    if (latch) temp |= 0x40;
    i2cDevice.I2CWriteByte(_xgAddress, INT_GEN_CFG_G, temp);
}
...
void LSM9DS1::configGyroThs(int16_t threshold, lsm9ds1_axis axis, uint8_t duration, bool wait)
{
    ...
    // axis will be 0, 1, or 2 (x, y, z respectively)
    i2cDevice.I2CWriteByte(_xgAddress, INT_GEN_THS_XH_G + (axis * 2), buffer[0]);
    i2cDevice.I2CWriteByte(_xgAddress, INT_GEN_THS_XH_G + 1 + (axis * 2), buffer[1]);

    // Write duration and wait to INT_GEN_DUR_XL
    uint8_t temp;
    temp = (duration & 0x7F);
    if (wait) temp |= 0x80;
    i2cDevice.I2CWriteByte(_xgAddress, INT_GEN_DUR_G, temp);
}

uint8_t LSM9DS1::getGyroIntSrc()
{
    uint8_t intSrc = i2cDevice.I2CReadByte(_xgAddress, INT_GEN_SRC_G);
...
void LSM9DS1::configMagInt(uint8_t generator, h_lactive activeLow, bool latch)
{
    ...
    i2cDevice.I2CWriteByte(_mAddress, INT_CFG_M, config);
}

void LSM9DS1::configMagThs(uint16_t threshold)
{
    // Write high eight bits of [threshold] to INT_THS_H_M
    i2cDevice.I2CWriteByte(_mAddress, INT_THS_H_M, uint8_t((threshold & 0x7F00) >> 8));
    // Write low eight bits of [threshold] to INT_THS_L_M
    i2cDevice.I2CWriteByte(_mAddress, INT_THS_L_M, uint8_t(threshold & 0x00FF));
}

uint8_t LSM9DS1::getMagIntSrc()
{
    uint8_t intSrc = i2cDevice.I2CReadByte(_mAddress, INT_SRC_M);
...
{
    uint8_t temp = i2cDevice.I2CReadByte(_xgAddress, CTRL_REG9);
    if (enable) temp |= (1<<6);
    else temp &= ~(1<<6);
    i2cDevice.I2CWriteByte(_xgAddress, CTRL_REG9, temp);
}
...
void LSM9DS1::setFIFO(fifoMode_type fifoMode, uint8_t fifoThs)
{
    ...
    i2cDevice.I2CWriteByte(_xgAddress, FIFO_CTRL, ((fifoMode & 0x7) << 5) | (threshold & 0x1F));
}

uint8_t LSM9DS1::getFIFOSamples()
{
    return (i2cDevice.I2CReadByte(_xgAddress, FIFO_SRC) & 0x3F);
}
