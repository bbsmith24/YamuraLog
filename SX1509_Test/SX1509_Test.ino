...
// SX1509 Pins:
const byte SX1509_PIN_0 = 0; // Active-low button
const byte SX1509_PIN_1 = 1; // Floating or jumpered input
...
void loop() 
{
  ...
  Serial.print(io.digitalRead(SX1509_PIN_0));
  Serial.print(" ");
  Serial.println(io.digitalRead(SX1509_PIN_1));
}
