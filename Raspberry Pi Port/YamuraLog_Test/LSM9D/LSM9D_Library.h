...
******************************************************************************/
#ifndef __LSM9DS_Library_H__
#define __LSM9DS_Library_H__
...
public:
    ...
    I2C_Library i2cDevice_AccelGyro;
    I2C_Library i2cDevice_Magnetometer;
...
//    int _fd;
    ...
    void init(uint8_t xgAddr, uint8_t mAddr);
