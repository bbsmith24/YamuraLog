...
#ifndef _SX1509_Library_H
#define _SX1509_Library_H

#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
//#include "SX1509_Registers.h"
#include "SX1509_Types.h"
...
#define SX1509_PIN_08 0x0001
#define SX1509_PIN_09 0x0002
#define SX1509_PIN_10 0x0004
#define SX1509_PIN_11 0x0008
#define SX1509_PIN_12 0x0010
#define SX1509_PIN_13 0x0020
#define SX1509_PIN_14 0x0040
#define SX1509_PIN_15 0x0080

#define SX1509_PIN_00 0x0100
#define SX1509_PIN_01 0x0200
#define SX1509_PIN_02 0x0400
#define SX1509_PIN_03 0x0800
#define SX1509_PIN_04 0x1000
#define SX1509_PIN_05 0x2000
#define SX1509_PIN_06 0x4000
#define SX1509_PIN_07 0x8000
...
public:
    ...
    // initialize I2C, resets the IC, read registers to prove it's connected.
    //	address: 7-bit address of the SX1509 - 0x3E (default), 0x3F, 0x70, 0x71
    //	resetPin: optional master IO pin tied to the SX1509 RST pin
    // Output: Returns a 1 if communication is successful, 0 on error.
    // -----------------------------------------------------------------------------
	uint8_t SX1509_Begin(uint8_t address = 0x3E, uint8_t resetPin = 0xFF);
...
// -----------------------------------------------------------------------------
    ...
    void readPins(I2C_Library::I2CWord *pins);
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
    ...
    uint8_t constrain(uint8_t val, uint8_t  low_limit, uint8_t high_limit);
};
